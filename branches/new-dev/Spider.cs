...
namespace Spider {
	...
	class Spider {
         ...
         *      @baseUrl        - the base URL of the site to be spidered
         *      @startUrl       - the starting URl of the site to be spidered
         *      @niceness       - time to wait inbetween HTTP requests (not currently respected, for testing)
         ...
         *                            at the index specified by the index field in the _SpiderWorkItemDataWrapper
     ...
     *                                    pages that we haven't seen before, which could be redirected links,
     *                                    but we have to grab the page to get its final URL; each _SpiderPageCandidate
