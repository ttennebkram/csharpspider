...
namespace Spider {
    ...
    public class SPage {
        ...
        /* SPage() -        make a new SPage object representing a page visited while spidering a site
         *  @url -          the URL of this page
         *  @ref_url -      the referring URL of this page- all pages have to start with one referring page
         */
        public SPage(string url, string ref_url) {
            this.url = url;
        ...
        /* SPage() -        make a new SPage object with pre-populated lists of linking and referring URLs
         *  @url -          the URL of this page
         ...
         */
        public SPage(string p_url, List<string> ref_url, List<string> link_url) {
            this.url = p_url;
            this.linking_to_urls = link_url;
            this.referenced_by_urls = ref_url;
        }

        /* getUrl() -       return this SPage's URL
         */
        public string getUrl() {
            return this.url;
        }

        /* getLinkingToUrls() - return this SPage's list of URLs that it links to
         */
        public List<string> getLinkingToUrls() {
            return this.linking_to_urls;
        }

        /* getReferencedByUrls() -  return this SPage's list of URLs that refer to it (i.e. link to it)
         */
        public List<string> getReferencedByUrls() {
            return this.referenced_by_urls;
        }

        /* addLinkingToUrl() -  add a new URL to this SPage's list of URLs that it links to
        ...
        /* addReferencedByUrl() -   add a new URL to this SPage's list of URLs that link to it
         *  @new_url -              the new URL to add to the list
         */
